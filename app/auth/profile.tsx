        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                    ...
                    {step === 1 && (
                        <View>
                            ...
                            <View style={styles.section}>
                                ...
                                <OptionPicker
                                    options={["Straight", "Gay", "Lesbian", "Bisexual", "Pansexual"]}
                                    selected={sexuality}
                    ...
                    {step === 3 && (
                        <View>
                            ...
                            <View style={styles.section}>
                                ...
                                <OptionPicker
                                    options={["Asian", "Black", "Hispanic/Latino", "White", "Mixed", "Other"]}
                                    selected={ethnicity}
                                    onSelect={setEthnicity}
                                />
                                <Text style={styles.label}>Religion</Text>
                                <OptionPicker
                                    options={["Agnostic", "Atheist", "Buddhist", "Christian", "Hindu", "Jewish", "Muslim", "Spiritual", "Other"]}
                                    selected={religion}
                                    onSelect={setReligion}
                                />
                                <Text style={styles.label}>Politics</Text>
                                <OptionPicker
                                    options={["Liberal", "Moderate", "Conservative", "Not Political", "Other"]}
                                    selected={politics}
                ...
                <View style={styles.fabContainer}>
                    <TouchableOpacity
                        style={[styles.fab, (!canProceed() || isSubmitting) && styles.fabDisabled]}
                        onPress={handleNext}
